...
import { Link } from "react-router-dom";
 export default function Services() {
        ...
        <div className="flip-card w-full">
          <div className="flip-card-inner w-full">
            <div className="flip-card-front w-full overflow-hidden">
              {Logo_Icons[i]}
              <h1 className="text-serif mt-1 text-center text-sm text-black md:mt-10 md:text-xl">
            ...
            <div className="flip-card-back overflow-hidden">
              ...
              <Link  to="/" className="relative mx-auto h-10 mt-5 animate-pulse rounded-md bg-green-900 px-8 text-sm font-semibold text-white shadow-sm duration-300 ease-in hover:scale-125">
           Vist
          </Link>
            </div>
          </div>
  ...
  return (
    <div
      id="our_services"
      className="  bg-transparrent h-full w-full overflow-scroll no-scrollbar border-t-2  border-blue-900/50  backdrop-blur-xl"
    >
      <div
        id="Heading_Projects"
